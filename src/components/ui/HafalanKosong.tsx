...
export const HafalanKosong = ({ 
  ...
  return (
    <div className="col-span-full py-32 text-center border-2 border-dashed border-border rounded-2xl bg-card">
      <div className="w-24 h-24 bg-surface-1 rounded-full flex items-center justify-center mx-auto mb-6 group cursor-pointer hover:bg-primary/20 hover:scale-110 transition-all duration-300">
