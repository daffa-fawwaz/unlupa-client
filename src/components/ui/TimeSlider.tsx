  ...
  return (
    <div className={`relative w-full py-4 ${className}`}>
      ...
      {label && (
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="text-lg font-mono font-bold text-primary">
            {value} <span className="text-xs text-muted-foreground">menit</span>
          </div>
        </div>
      )}
      ...
      <div className="relative w-full">
        ...
        {/* Time markers */}
        <div className="absolute top-8 left-0 right-0 flex justify-between text-xs text-muted-foreground px-1">
          <span>{min}m</span>
