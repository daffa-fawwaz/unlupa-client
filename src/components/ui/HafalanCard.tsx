...
export const HafalanCard = ({ item }: HafalanCardProps) => {
  // Processing Content Ref
  let displayTitle = "";
  let displaySubtitle = "";
    ...
    <div className="group relative flex flex-col p-7 rounded-[2.5rem] bg-gray-900/40 border border-white/5 hover:border-amber-500/50 backdrop-blur-sm transition-all duration-500 hover:shadow-2xl hover:shadow-amber-500/10 hover:-translate-y-2 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
          ...
          <button className="opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 bg-amber-500 hover:bg-amber-400 text-black p-2.5 rounded-xl shadow-lg shadow-amber-500/20 hover:shadow-amber-500/40">
