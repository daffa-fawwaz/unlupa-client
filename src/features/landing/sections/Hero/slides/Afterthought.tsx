    ...
    <SlideContainer>
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center relative z-10 mt-2">
        ...
        <div className="relative space-y-8 max-w-5xl mx-auto">
          ...
          <div className="relative group">
            ...
            <div className="relative inline-block">
              <h1 className="relative z-10 font-display font-black text-3xl sm:text-4xl md:text-6xl text-foreground tracking-tight leading-tight transition-transform duration-500 group-hover:scale-105">
                KE MANA PERGINYA?
              </h1>
              <h1 className="relative z-10 font-display font-black text-3xl sm:text-4xl md:text-6xl text-destructive tracking-tight leading-tight transition-transform duration-500 group-hover:scale-105">
                USAHA DAN WAKTU?
              </h1>
              {/* Scratch/Line Effect */}
        ...
        <div className="absolute left-8 md:left-24 bottom-32 hidden md:block opacity-60 animate-float delay-500">
          <div className="p-4 rounded-full border border-destructive/20 bg-destructive/5">
            <TrendingDown className="w-8 h-8 text-destructive" />
          </div>
        </div>

        {/* Bottom Badge */}
        <div className="mt-12 flex items-center gap-3 px-6 py-2 rounded-full border border-destructive/30 bg-destructive/10 backdrop-blur-md animate-pulse">
          <div className="w-2 h-2 rounded-full bg-destructive animate-ping" />
          <span className="text-destructive text-xs md:text-sm font-mono tracking-widest uppercase">
            Critical Data Loss
          </span>
        </div>
      </div>
