    ...
    <SlideContainer>
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center relative z-10 mt-2">
        ...
        <div className="relative space-y-6 md:space-y-8 max-w-5xl mx-auto">
          <h3 className="font-serif text-2xl md:text-4xl text-foreground/90 font-light tracking-wide">
            Belajar seharusnya untuk
          </h3>

          <div className="relative inline-block group">
            {/* Glitch Effect Layers */}
            <h1 className="relative z-10 font-display font-black text-6xl sm:text-7xl md:text-9xl text-foreground tracking-tighter transition-transform duration-500 group-hover:scale-105">
              DIINGAT
            </h1>
          ...
          <div className="flex items-center justify-center gap-4 text-xl md:text-3xl font-light text-foreground/80">
            <span>Bukan untuk</span>
            <span className="relative px-3 py-1">
              <span className="absolute inset-0 bg-destructive/10 skew-x-12 border border-destructive/20"></span>
              <span className="relative text-destructive font-serif italic decoration-destructive/50 decoration-2 underline-offset-4 line-through">
                dilupakan
              </span>
            </span>
          </div>
        ...
        {/* Bottom Badge */}
        <div className="mt-12 md:mt-16 flex items-center gap-2 text-accent/60 text-xs md:text-sm font-mono tracking-[0.2em] border border-accent/20 px-4 py-1.5 rounded-full bg-accent/5">
