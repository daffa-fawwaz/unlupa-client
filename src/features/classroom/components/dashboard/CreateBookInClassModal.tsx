...
export const CreateBookInClassModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      <div className="bg-card border border-border rounded-2xl max-w-xl w-full flex flex-col max-h-[90vh] relative shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
