...
export const ClassroomHeader = ({
  ...
  return (
    <header className="relative overflow-hidden rounded-2xl border border-border bg-card p-5 text-foreground sm:p-6">
      ...
      <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-2xl">
          <span className="inline-flex w-max items-center gap-2 rounded-full border border-border bg-surface-1 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-success">
