...
export const CreateBookModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="w-full max-w-137.5 bg-card border border-primary/30 rounded-2xl shadow-xl relative max-h-[90vh] flex flex-col">
        ...
        <form
          ...
          className="relative z-10 w-full overflow-y-auto px-8 md:px-10 pb-8 flex flex-col"
        >
          ...
          >
            {loading ? (
              <>
                ...
                <span className="opacity-90">Menyimpan Kitab...</span>
              </>
            ) : (
              <>
                <PlusCircle className="w-5 h-5" />
                <span>Publikasikan Kitab</span>
              </>
            )}
          </button>
        </form>
